...
class ArticleMenuAdaptor implements MenuAdaptorInterface
{
    ...
    {
        $overviewpageNodes = $em->getRepository('KunstmaanNodeBundle:Node')->findByRefEntityName('Sandbox\\WebsiteBundle\\Entity\\Article\\ArticleOverviewPage');
    ...
    public function adaptChildren(MenuBuilder $menu, array &$children, MenuItem $parent = null, Request $request = null)
    {
        if (!is_null($parent) && 'topmenucategory1' == $parent->getRoute()) {
            ...
            $menuitem->setInternalName('Article');
...
//            // Author
//            $menuitem = new TopMenuItem($menu);
//            $menuitem->setRoute('sandboxwebsitebundle_admin_article_articleauthor');
