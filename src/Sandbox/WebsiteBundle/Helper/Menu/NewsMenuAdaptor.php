...
class NewsMenuAdaptor implements MenuAdaptorInterface
{
    ...
    {
        $overviewpageNodes = $em->getRepository('KunstmaanNodeBundle:Node')->findByRefEntityName('Sandbox\\WebsiteBundle\\Entity\\News\\NewsOverviewPage');
    ...
    public function adaptChildren(MenuBuilder $menu, array &$children, MenuItem $parent = null, Request $request = null)
    {
        if (!is_null($parent) && 'topmenucategory1' == $parent->getRoute()) {
            ...
            $menuitem->setRoute('sandboxwebsitebundle_admin_news_newspage');
            $menuitem->setInternalName('News');
