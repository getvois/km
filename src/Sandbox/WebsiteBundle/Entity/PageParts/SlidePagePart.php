 ...
 * SlidePagePart
 *
 * @ORM\Table(name="sb_slide_page_part")
 * @ORM\Entity
 */
class SlidePagePart extends \Kunstmaan\PagePartBundle\Entity\AbstractPagePart
{
    ...
    {
        return 'SandboxWebsiteBundle:PageParts:SlidePagePart/view.html.twig';
    }

    /**
     * Get the admin form type.
     *
     * @return \Sandbox\WebsiteBundle\Form\Pageparts\SlidePagePartAdminType
     */
    public function getDefaultAdminType()
    {
        return new \Sandbox\WebsiteBundle\Form\PageParts\SlidePagePartAdminType();
    }
}